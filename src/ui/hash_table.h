...
Ht_item *create_item(int key, Person *value)
{
...
void ht_insert(HashTable *table, int key, Person *value)
{
    // Create the item
...
Person *ht_search(HashTable *table, int key)
{
...
void print_hashtable(HashTable *table)
{
    ...
    for (int i = 0; i < table->size; i++)
    {
        if (table->items[i])
        {
            ...
            print_person(table->items[i]->value);
